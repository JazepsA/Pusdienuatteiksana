...
def skolnieku_logs():
    ...
    pievienot_btn = tk.Button(skolnieki_logs, text="Pievienot sportistu", command=pievienot_skolnieku, width=25, height=2, bg="lightblue")
    pievienot_btn.pack(pady=10)

    meklēt_btn = tk.Button(skolnieki_logs, text="Meklēt sportistu", command=meklēt_skolnieku, width=25, height=2, bg="lightgreen")
    meklēt_btn.pack(pady=10)

    dzēst_btn = tk.Button(skolnieki_logs, text="Dzēst sportistu", command=dzēst_sportistu, width=25, height=2, bg="lightyellow")
    dzēst_btn.pack(pady=10)
